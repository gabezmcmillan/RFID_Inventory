...
Last reconciled for Plan 011 on 2026-07-23, at commit `151a536`.
...
- **011's isolated development infrastructure dependency is satisfied**:
  ...
  API (no supervisor, no QR redesign, no new deps); it still does not depend on
  or duplicate Plan 010's production sync/import/cutover. Land 011 before
  relying on a physical phone for Plan 010's local web/API integration tests.
