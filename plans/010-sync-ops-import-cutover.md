...
- **Status**: IN_PROGRESS — Phase 1 credential gate PASSED (`DIRECT_SYNC_PASS`); Phase 2 (collision-safe IDs, local-only device state, credential control) PASSED its verify gate; Phases 3–7 pending
